...
class PreferencesWindow():
    ...
    def fill_preference_colors(self):
        self.board_color_1=configuration.BOARD_COLOR_1
        self.board_color_2=configuration.BOARD_COLOR_2
        self.highlight_color=configuration.HIGHLIGHT_COLOR
    ...
    def set_new_values(self):
        ...
        configuration.BOARD_COLOR_1=self.board_color_1
        configuration.BOARD_COLOR_2=self.board_color_2
        configuration.HIGHLIGHT_COLOR=self.highlight_color
